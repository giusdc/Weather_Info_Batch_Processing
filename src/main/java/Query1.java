...
public class Query1 {
    ...
    public static void getResponse(SparkSession spark, String pathWeather, List<ZoneId> zoneIdList, String format, String[] citiesList, FSDataOutputStream writer,int indexCicle) throws IOException {
